...
Print the groups and datasets in an HDF5 along with some sampled information
about the values in those datasets (the values shown are samples, and are
not exact for the full dataset).
